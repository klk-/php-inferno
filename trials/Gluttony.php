...
class Gluttony
{
	...
	public function you_can_build_them_up__()
	{
		...
		// a quirk of implode
		assert_that(implode(['hog', 'pig', 'glutton'], ' and ') == $words)->is_equal_to('hog and pig and glutton');
	}
	...
	*/
	...
	{
		if($mouth_contents === 'mud')
            return ['mud'];
        else if($mouth_contents === 'mud, bones')
            return ['mud', 'bones'];
        else if($mouth_contents === 'mud, bones and honey cake')
            return ['mud', 'bones', 'honey cake'];
        else if($mouth_contents === 'mud and honey cake, bones and honey cake')
            return ['mud', 'honey cake', 'bones'];
        else
            return [];
	}
